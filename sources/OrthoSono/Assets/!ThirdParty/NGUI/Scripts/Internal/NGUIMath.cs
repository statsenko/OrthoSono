...
static public class NGUIMath
{
	...
	static public Bounds CalculateAbsoluteWidgetBounds (Transform trans, bool includeInactive = false)
	{
		UIWidget[] widgets = trans.GetComponentsInChildren<UIWidget>(includeInactive) as UIWidget[];
	...
	static public Bounds CalculateRelativeWidgetBoundsIncludeInactive (Transform root, Transform child)
	{
		return CalculateRelativeWidgetBounds (root, child, true);
	}

	static public Bounds CalculateRelativeWidgetBounds (Transform root, Transform child, bool includeInactive = false)
	{
