...
public class UIAnchor : MonoBehaviour
{
	...
	public virtual void Update ()
	{
		...
		{
			Vector3 ls = transformContainer.localScale;
			Vector3 lp = transformContainer.localPosition;

			Bounds b = NGUIMath.CalculateRelativeWidgetBounds(transformContainer);
			Vector3 size = b.size;

			mRect.x = lp.x + b.min.x * ls.x;
			mRect.y = lp.y + b.min.y * ls.y;
