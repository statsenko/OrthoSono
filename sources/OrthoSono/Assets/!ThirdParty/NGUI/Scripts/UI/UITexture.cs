...
public class UITexture : UIWidget
{
	...
	public override void OnFill (BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
	{
		...
		verts.Add(new Vector3(1f*fillAmount,  0f, 0f));
		verts.Add(new Vector3(1f*fillAmount, -1f, 0f));
		verts.Add(new Vector3(0f, -1f, 0f));
		verts.Add(new Vector3(0f,  0f, 0f));

		uvs.Add(new Vector2(mRect.xMax-(mRect.width *(1.0f-fillAmount)), mRect.yMax));
		uvs.Add(new Vector2(mRect.xMax-(mRect.width *(1.0f-fillAmount)), mRect.yMin));
